<?php
  ...
  $posts = [
    ...
    [
      ...
      'tags' => ['PHP', 'OOP', 'Programação Avançada'],
      'img' => 'prog-2.jpg'
    ],
    [
      'id' => 3,
    ...
    [
      'id' => 4,
      'title' => 'Programando com Vuejs',
      'description' => 'Neste post você vai aprender tudo que precisa para ser um bom programador com Vuejs!',
      'tags' => ['programação', 'Vuejs', 'lógica de programação'],
      'img' => 'prog-5.png'
    ],
